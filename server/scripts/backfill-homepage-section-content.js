...
import { mergeMissingSettings } from "../src/modules/pages/homepage-content.js";
...
export async function backfillHomepageSectionContent() {
  ...
  const updates = page.sections.filter((section) => JSON.stringify(mergeMissingSettings(section.type, section.settings)) !== JSON.stringify(section.settings || {}));
